<%-- 
 <section class="content" >
            <div ng-show="tenderlistshow" class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Project list </h3>
                            <h3><button class="btn btn-blue pull-left" style="margin-top:-5px; border-radius : 0;" ng-click="exportTenderList()"><i class="fa fa-plus"></i> Export </button></h3>
                            <div class="box-tools pull-right">
                 
                                   
                                   <button type="button"  ng-click="tenderaddload()" class="btn btn-box-tool" data-widget="add">
                        ...
                        <div class="box-body">
							...
							<table  ng-table="tenderListTable" class="data-table table table-bordered table-striped table-responsive">
										<thead>
											<tr>
											   <th>SL No.</th>
											    <th>LOA Details</th>
