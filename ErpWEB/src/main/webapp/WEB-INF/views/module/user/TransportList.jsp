 ...
 <section class="content" ng-init="getAllTransport()">
            <div  class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
									...
									<i class="fa fa-plus"></i><a href="#addtransport">ADD Transport</a> 
                   ...
                   <!--      <div class="box-body" ng-init="accountsLoad()">
                            <div class="row">
								<div class="col-md-3">
								    <div class="form-group">
										<label for="af2">Search Transport</label>
                        ...
                        <div class="box-body">
							...
							<table  ng-table="transportData" class="data-table table table-bordered table-striped table-responsive">
										<thead>
											<tr>
											   <th>SL No.</th>
											    <th>Transport No</th>
										...
										<tbody>
												...
												<td>{{ $index + 1 }}</td>
									                ...
									                <td><a  style="cursor:pointer; " ><b> {{datas.transportNo}}</b></a></td>
									               <td >{{datas.transportName}}</td> 
												
												
												<td>{{datas.capacity}}</td>
														<td class="action" width="1">
													<i class="fa fa-eye text-primary" aria-hidden="true"><a href="#addNewturnover/{{datas.project_code}}"></a></a></i>
