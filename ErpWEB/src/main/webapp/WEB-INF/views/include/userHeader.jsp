<!DOCTYPE html>
<html lang="en" ng-app="csmApp" ng-controller="userCtrl">
<head>
<meta charset="utf-8">
...
<div class="wrapper">
    <header class="main-header"> 
        ...
        <span class="logo-lg"><b>Param</b> Enterprises Pvt. Ltd.</span> </a> 
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
								<img src="/assets/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                <p> {{currentUserName}} - Sales Manager <small></small> </p>
                            </li>
                            <!-- Menu Body -->
