 <!--Footer-->
    <footer class="main-footer"> <strong>Copyright &copy; 2018-2019 <a href="index.html">ETS</a>.</strong> All rights reserved. </footer>
</div>
<!-- ./wrapper --> 
...
<!-- Bootstrap WYSIHTML5 --> 
<script src="/assets/js/wysihtml5.all.min.js"></script> 
<!-- Slimscroll --> 
